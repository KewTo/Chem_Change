            ...
            while True:
                ...
                if COAT_TOOL == 'ACT01' or COAT_TOOL == 'CCT01':
                    ...
                    if CHEM_LINE == 'ACT12' or CHEM_LINE == 'ACT13' or CHEM_LINE == 'C21' or CHEM_LINE == 'C21B':
                        BOTTLE = 'EMX-7306'
                    elif CHEM_LINE == 'ACT11' or CHEM_LINE == 'ACT14' or CHEM_LINE == 'C14' or CHEM_LINE == 'C14B':
                        BOTTLE = 'EMX-7310'
...
def prompt_script():
    ...
    if TOOL == 'ACT01' or TOOL == 'CCT01' or TOOL == 'CCT02':
        print(
    ...
    elif TOOL == 'RCT03' or TOOL == 'RCT05' or TOOL == 'GCT01' or TOOL == 'GCT02':
        print(
